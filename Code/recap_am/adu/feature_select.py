...
def select_kbest(input_doc, load=False, scaler="None"):
...
def pca(input_doc, load=False, scaler="None"):
...
def pca_selectk_union(input_doc, load=False, scaler="None"):
...
def full_run(input_doc):
    ...
    input_doc = variance_threshold(input_doc, load=False)
    print(len(input_doc._.Features[0]))
